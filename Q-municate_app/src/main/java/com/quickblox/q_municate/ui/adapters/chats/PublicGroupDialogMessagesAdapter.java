...
public class PublicGroupDialogMessagesAdapter extends BaseDialogMessagesAdapter {

    public PublicGroupDialogMessagesAdapter(BaseActivity baseActivity, List<CombinationMessage> objectsList,
    ...
    public void onBindViewHolder(BaseClickListenerViewHolder<CombinationMessage> baseClickListenerViewHolder, int position) {
        ...
        if (notificationMessage) {
            ...
            if (ownMessage) {
                ...
                viewHolder.nameTextView.setTextColor(colorUtils.getColorByUser(combinationMessage.getDialogOccupant().getUser()));
