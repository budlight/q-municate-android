...
class DemoPlayer implements ExoPlayer.Listener, ChunkSampleSource.EventListener,
    ...
    private static final int TRACK_DISABLED = ExoPlayer.TRACK_DISABLED;
    ...
    private int getSelectedTrack(int type) {
        return player.getSelectedTrack(type);
    }

    private void setSelectedTrack(int type, int index) {
    ...
    public void setMuted(boolean muted) {
        ...
        this.muted = muted;
        if (muted) {
            audioTrackToRestore = getSelectedTrack(TYPE_VIDEO);
